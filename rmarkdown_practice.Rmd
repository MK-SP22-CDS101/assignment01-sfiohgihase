...
By the end of the course, students will be able to:
  ...
  * Use [GitHub](github.com) for creating a reproducible research document. 
     - My GitHub username is: *sfiohgihase*
...
x + 3
```
The output of first line of code is not prited out because it is assigned to a variable instead.

The second line of out put is printed out instead, but this means that the calculated value has not been saved for future use.
